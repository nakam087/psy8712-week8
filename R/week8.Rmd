...
An image of this project as of ***`r Sys.Date()`*** can be accessed by [clicking this link](#mybinder.org). An interactive web app is available by [clicking this link instead (#more link).
